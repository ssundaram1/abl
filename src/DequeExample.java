...
public class DequeExample
{
    public static void main(String[] args)
    {
        ...
        deque.remove();
        System.out.println("Deque after removing only " + deque);
        deque.add(" Element 10 ");
        System.out.println("Deque after adding only " + deque);
        deque.remove();
        System.out.println("Deque after removing " +
                "only: " + deque);
        deque.push(" TEST");
        System.out.println("Deque after pushing " +
                ": " + deque);
        deque.pop();
        System.out.println("Deque after popping " +
                ": " + deque);
